...
class FinanceLedger:
    ...
    def with_interpretation(self, interpretation: Interpretation) -> "FinanceLedger":
        ...
        if interpretation.reverses_id is not None:
            ...
            if any(item.source_activity_id == interpretation.source_activity_id for item in self.interpretations):
                raise FinanceError("source activity is already interpreted", FinanceErrorCode.INVALID)
