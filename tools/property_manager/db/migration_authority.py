...
def _parse_manifest(data: bytes) -> AuthorityManifest:
    try:
        ...
        if type(snapshots) is not dict or list(snapshots) != ["009", "010", "011"] or raw["current_snapshot"] != "011":
        ...
        if reserved_versions != ["007", "008"] or raw["next_canonical_version"] != "012":
            raise AuthorityConfigurationError("reserved or next migration version is invalid")
        return AuthorityManifest(parsed_snapshots, "011", ("007", "008"), "012")
