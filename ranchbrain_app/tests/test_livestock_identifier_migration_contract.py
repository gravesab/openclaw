...
class LivestockIdentifierMigrationContractTests(unittest.TestCase):
    ...
    def test_result_references_are_tenant_safe_and_operation_exact(self):
        ...
        self.assertIn("REFERENCES ranchos.animal_identifiers (tenant_id, id)\n        NOT VALID", sql)
        ...
        self.assertIn("REFERENCES ranchos.animal_identifier_retirements (tenant_id, id)\n        NOT VALID", sql)
        self.assertIn(") NOT VALID;", sql)
        self.assertGreaterEqual(sql.count("NOT VALID"), 3)
